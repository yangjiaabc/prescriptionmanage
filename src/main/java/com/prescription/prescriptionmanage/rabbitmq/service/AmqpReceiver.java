package com.prescription.prescriptionmanage.rabbitmq.service;

import com.prescription.prescriptionmanage.rabbitmq.config.AmqpConfirguration;
...
/**
    ...
    public void simpleReceive(String message) {
        System.out.println("简单模式接收消息1:" + message);
    }
...
/**
    ...
    *//*
    ...
    @RabbitListener(queues = AmqpConfirguration.PS_QUEUE_3)
    public void psReceive3(String message) {
        System.out.println(AmqpConfirguration.PS_QUEUE_3 + "接收消息:" + message);
    }
