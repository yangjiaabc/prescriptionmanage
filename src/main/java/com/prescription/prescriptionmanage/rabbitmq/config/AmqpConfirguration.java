package com.prescription.prescriptionmanage.rabbitmq.config;
...
public class AmqpConfirguration {
    ...
    public static final String PS_QUEUE_3 = "ps_queue_3";
    ...
    @Bean
    public Queue psQueue3() {
        return new Queue(PS_QUEUE_3, true);
    }
    ...
    public Binding fanoutBinding3() {
        return BindingBuilder.bind(psQueue3()).to(fanoutExchange());
    }
    ...
    public Binding directBinding1() {
	    return BindingBuilder.bind(routingQueue1()).to(directExchange()).with("search");
    }

    @Bean
	public Binding directBinding2() {
	    return BindingBuilder.bind(routingQueue2()).to(directExchange()).with("user");
    }
