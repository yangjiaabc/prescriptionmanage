...
//            });
    ...
    public static boolean has(String json ,String key) {
        ...
        boolean has = je.getAsJsonObject().has(key);
        return has;
    }

    public static String getKey(String json,String key){
        JsonElement  je = new JsonParser().parse(json);
        String asString = je.getAsJsonObject().get(key).getAsString();
        return asString;
    }

    public static  JsonElement parser(String json){
        JsonElement  je = new JsonParser().parse(json);
        return  je;
    }
